...
<template>
  <Transition name="fade">
    <div class="fixed top-0 left-0 w-screen h-screen bg-black opacity-50 z-20" v-if="props.modelValue" @click="emits('update:modelValue', false)" />
  </Transition>
  <div class="print:hidden fixed z-20 top-0 w-11/12 sm:w-96 bg-white h-screen all-transition pb-4 overflow-y-auto" :class="props.modelValue ? 'right-0' : '-right-full'">
