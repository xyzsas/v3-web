...
<template>
  ...
  <div class="print:hidden fixed top-0 w-11/12 sm:w-96 bg-white min-h-screen all-transition pb-4 overflow-y-auto" :class="props.modelValue ? 'right-0' : 'sm:-right-96 -right-full'">
