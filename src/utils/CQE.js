export const T = {
  ...
  '社会实践和劳动教育': {
    '社区服务': ['每个人根据生活学习区域情况自觉主动参加社区服务活动，至少一次，每次不少于半天', '熟悉社区中与自己生活密切相关的公共场所、基础设施和组织机构（1-5分）。对社区的地理环境、人文环境、物产特色、民间风俗和传统节日有所了解,并萌发对家乡的关爱之情（1-5分）。愿意为社区建设和发展服务,有较强的服务意识和责任心,体验服务的充实与愉悦(1-5分)。关心社区中的重大活动和社区存在的主要问题,并尝试运用自己所学知识分析和解决具体问题,从中获得积极的感受(1-5分)。自觉维护社区形象。逐步形成建设良好生活环境的情感和态度(1-5分)。在服务的过程中学会交往、合作,懂得理解和尊重,形成团结意识和归属感，增强服务意识和责任感（1-5分）。社区服务1次以上，每增加一次加5分，满分30分。', '《江苏省普通高中课程设置及教学指导意见》《江苏省普通高中学生综合素质评价实施方案》', '社区服务', '社会实践和劳动教育'],
    '社会实践': ['每个人根据学校安排和生活学习的区域的情况特点，积极参加社会实践活动，至少一次，每次不少于半天。', '参加社会实践活动的达到时间要求和态度认真（1-5分）。活动的选择与活动设计评价（1-5分）。活动过程中的体验和收获：认识社会、研究社会问题的基本能力和人际交往，协作、适应环境等能力的发展情况（1-5分）。活动的成果和社会效益评价（1-5分）。活动过程中的创新性和实践性的体现情况（1-5分）。社会实践1次以上，每增加一次加5分，满分20分。', '《江苏省普通高中课程设置及教学指导意见》《江苏省普通高中学生综合素质评价实施方案》', '社会实践', '社会实践和劳动教育'],
    '社团活动': ['引领组织社团，争做社团活动领袖，积极参加社团组织各种活动。', '参加的社团达到规定次数的加4分、在社团中的职务（社长2分、副社长1分）、过程和成效（1-4分）。', '', '社团活动', '社会实践和劳动教育'],
    '规定性课程': ['内务班务校务实践、烹饪、志愿服务', '学会个人生活事务处理（1-5分），开展校园爱国卫生运动，增强爱班爱校的集体主义意识（1-5分），学会烧8道淮扬特色菜，传承家乡美食文化（1-5分），运用所学知识技提供服务，树立服务意识（1-5分）', '《江苏省扬州中学劳动教育课程方案》', '规定性课程', '社会实践和劳动教育'],
    '自主性课程': ['家务劳动类、绿化维护类、家禽养殖类、手工制作类、园艺苗圃类、西点烘焙类、饮品制作类、农耕栽培类、校外实践类、义卖义演类、儿童陪护类、技术实训类、职业体验类', '注重生活能力和良好劳动习惯培养，树立自立自强意识（1-5分）。经历工农业生产中物质财富创造过程，掌握相关技术，感受劳动创造价值（1-5分）。在服务性岗位上见习实习，树立服务意识（1-5分）。在公益劳动中强化社会责任感（1-5分）。每参加一项劳动半天以上并有劳动成果展示（一次加5分）', '', '自主性课程', '社会实践和劳动教育']
  }
}